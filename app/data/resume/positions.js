const positions = [{
  ...
  points: [
  <span>Built <a href="https://screeningapidocs.cityofnewyork.us/">benefit screening API</a> that enables New York City households to screen for potential program eligibility.</span>,
  ...
  <span>Developed a Node.js/React application to collect data from NYC social service sites, giving the mayor&apos;s office a <a href="https://www1.nyc.gov/site/opportunity/portfolio/social-service-location.page">comprehensive picture</a> of where city services are delivered and how they are funded.</span>,
  <span>Digitized <a href="https://www1.nyc.gov/site/rentfreeze/index.page">SCRIE and DRIE</a> rent freeze application for NYC Public Engagement Unit outreach staff</span>
  ],
}, {
  company: 'Uber',
